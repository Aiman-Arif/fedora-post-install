...
custom_commands=(
  ...
  # Installing commonly used apps
  "sudo dnf install -y gnome-tweaks unzip p7zip p7zip-plugins unrar; flatpak install -y one.ablaze.floorp io.github.realmazharhussain.GdmSettings com.mattjakeman.ExtensionManager ca.desrt.dconf-editor"
)
