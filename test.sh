...
yad_dialogs () {
    ...
    user_select_de=$(yad --list --title="Select Your Desktop Environment" --column="DE" "${user_de[@]}" --width=500 --height=500 )
    ...
    yad --question --text="You have selected ${user_select_de%|} as your DE. Is this correct?" --button="No:1" --button="Yes:0" --width=300 --height=150
    if [ $? -ne 0 ]; then
...
yad_dialogs user_de[@] custom_ops[@] custom_commands[@]